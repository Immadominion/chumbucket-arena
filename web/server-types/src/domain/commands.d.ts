 ...
 */
import type { Bucket, ChallengeId, Frost, MarketId, MatchId, Wallet } from "./ids";
import type { VerdictTrigger } from "./model";
...
export type Command = SignContract | Deposit | Withdraw | MakeCall | DeclareHotTake | RequestVerdict | CreateChallenge | AcceptChallenge | CancelChallenge;
